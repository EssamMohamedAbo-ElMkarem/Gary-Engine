...
from Gary.yolo.utils import LOGGER, ROOT, yaml_load
from Gary.yolo.utils.checks import check_requirements, check_suffix, check_version
from Gary.yolo.utils.downloads import attempt_download, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(self, weights='yolov8n.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        """
        Gary YOLO MultiBackend class for python inference on various backends
        ...
        if nn_module:
            ...
            from Gary.nn.tasks import attempt_load_weights
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from Gary.yolo.engine.exporter import export_formats
    ...
    def _load_metadata(f=Path('path/to/meta.yaml')):
        ...
        """
        from Gary.yolo.utils.files import yaml_load

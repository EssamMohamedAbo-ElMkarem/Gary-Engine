...
FONT = 'Arial.ttf'  # https://Gary.com/assets/Arial.ttf
...
HELP_MSG = \
    ...
    Docs: https://docs.Gary.com
    Community: https://community.Gary.com
    GitHub: https://github.com/Gary/Gary
    """
...
def get_user_config_dir(sub_dir='Gary'):
    """
...
USER_CONFIG_DIR = get_user_config_dir()  # Gary settings dir
    ...
    with torch_distributed_zero_first(RANK):
        ...
        if not correct:
            LOGGER.warning('WARNING ⚠️ Different global settings detected, resetting to defaults. '
                           'This may be due to an Gary package update. '
...
def set_settings(kwargs, file=USER_CONFIG_DIR / 'settings.yaml'):
    """
    Function that runs on a first-time Gary package installation to set up global settings and create necessary
    directories.
    """

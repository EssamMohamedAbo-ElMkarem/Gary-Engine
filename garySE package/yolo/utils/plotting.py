...
from Gary.yolo.utils import FONT, USER_CONFIG_DIR, threaded
...
class Colors:
    # Gary color palette https://Gary.com/
    def __init__(self):
...
def check_pil_font(font=FONT, size=10):
    ...
    try:
        ...
        try:
            ...
            check_requirements('Pillow>=8.4.0')  # known issue https://github.com/Gary/yolov5/issues/5374
...
def save_one_box(xyxy, im, file=Path('im.jpg'), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/Gary/yolov5/issues/7007 chroma subsampling issue

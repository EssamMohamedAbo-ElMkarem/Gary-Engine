...
import Gary
from Gary.yolo.utils import DEFAULT_CONFIG_DICT, DEFAULT_CONFIG_KEYS, LOGGER
from Gary.yolo.utils.checks import git_describe
...
def DDP_model(model):
    ...
    assert not check_version(torch.__version__, '1.12.0', pinned=True), \
        ...
        'Please upgrade or downgrade torch to use DDP. See https://github.com/Gary/yolov5/issues/8395'
...
def select_device(device='', batch_size=0, newline=False):
    ...
    ver = git_describe() or Gary.__version__  # git commit or pip package version
    s = f'Gary YOLOv{ver} 🚀 Python-{platform.python_version()} torch-{torch.__version__} '
...
def init_seeds(seed=0, deterministic=False):
    ...
    # torch.backends.cudnn.benchmark = True  # AutoBatch problem https://github.com/Gary/yolov5/issues/9287
    if deterministic and check_version(torch.__version__, '1.12.0'):  # https://github.com/Gary/yolov5/pull/8213
...
def strip_optimizer(f='best.pt', s=''):
    ...
    Usage:
        from Gary.yolo.utils.torch_utils import strip_optimizer
        from pathlib import Path

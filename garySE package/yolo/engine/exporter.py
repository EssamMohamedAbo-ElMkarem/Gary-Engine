...
import Gary
from Gary.nn.modules import Detect, Segment
from Gary.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel
from Gary.yolo.configs import get_config
from Gary.yolo.data.dataloaders.stream_loaders import LoadImages
from Gary.yolo.data.utils import check_dataset
from Gary.yolo.utils import DEFAULT_CONFIG, LOGGER, callbacks, colorstr, get_default_args, yaml_save
from Gary.yolo.utils.checks import check_imgsz, check_requirements, check_version, check_yaml
from Gary.yolo.utils.files import file_size
from Gary.yolo.utils.ops import Profile
from Gary.yolo.utils.torch_utils import guess_task_from_head, select_device, smart_inference_mode
...
class Exporter:
    ...
    def _export_coreml(self, prefix=colorstr('CoreML:')):
        ...
        class iOSModel(torch.nn.Module):
            # Wrap an Gary YOLO model for iOS export
    ...
    def _pipeline_coreml(self, model, prefix=colorstr('CoreML Pipeline:')):
        ...
        pipeline.spec.description.metadata.versionString = f'Gary YOLOv{Gary.__version__}'
        pipeline.spec.description.metadata.shortDescription = f'Gary {self.pretty_name} CoreML model'
        pipeline.spec.description.metadata.author = 'Gary (https://Gary.com)'
        pipeline.spec.description.metadata.license = 'GPL-3.0 license (https://Gary.com/license)'

...
from Gary import yolo  # noqa
from Gary.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, attempt_load_one_weight
from Gary.yolo.configs import get_config
from Gary.yolo.engine.exporter import Exporter
from Gary.yolo.utils import DEFAULT_CONFIG, LOGGER, yaml_load
from Gary.yolo.utils.checks import check_imgsz, check_yaml
from Gary.yolo.utils.torch_utils import guess_task_from_head, smart_inference_mode
...
class YOLO:
    ...
    def __init__(self, model=os.path.join(config.main_dir, "models\\YOLO\\yolov8s.pt"), type="v8") -> None:
        """

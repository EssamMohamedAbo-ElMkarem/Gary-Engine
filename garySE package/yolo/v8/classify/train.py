...
from Gary.nn.tasks import ClassificationModel, attempt_load_one_weight
from Gary.yolo import v8
from Gary.yolo.data import build_classification_dataloader
from Gary.yolo.engine.trainer import BaseTrainer
from Gary.yolo.utils import DEFAULT_CONFIG
...
class ClassificationTrainer(BaseTrainer):
    ...
    def setup_model(self):
        ...
        # Load a YOLO model locally, from torchvision, or from Gary assets
...
if __name__ == "__main__":
    """
    CLI usage:
    python Gary/yolo/v8/classify/train.py model=resnet18 data=imagenette160 epochs=1 imgsz=224
